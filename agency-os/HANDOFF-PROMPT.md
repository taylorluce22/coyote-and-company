...
I connect vetted 503B compounding facilities (suppliers) with license-verified clinical buyers (med spas with medical directors, IV therapy clinics, men's health clinics, ophthalmology and dermatology practices). I am a **marketing and introduction agency only**: the supplier quotes, prices, contracts, invoices, and ships — the supplier is seller-of-record on every transaction. I never take title or possession of product, never transmit pricing or quotes, never negotiate a sale. That activity discipline is exactly what keeps me outside state wholesale-distributor/broker licensing and federal DSCSA trading-partner status, so it is not a style preference — it is the legal architecture. I'm paid by suppliers on performance only: a per-qualified-meeting fee and a commission on their collected revenue from accounts I introduce (no retainer — decided 2026-08-01, see gtm/pricing-benchmarks.md).
