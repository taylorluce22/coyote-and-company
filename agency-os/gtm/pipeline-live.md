...
> ⚠️ **Fri 8/28 13:35 UTC — fourteenth consecutive scheduled fire without Gmail** (8/11–8/14, 8/17–8/21, 8/24–8/28). Last verified state is Fri 8/14 ~14:00 UTC, **two weeks old**. Every accurate update this file has ever received came from an interactive session; the schedule has never once succeeded.
>
...
> |---|---|---|
> | **ProRx follow-up** | Dave Dugas due back ~8/17 | 11 — copy ready |
> | **Belmar A3 (day 7)** | Sent 8/10 21:01; day-3 also missed on 8/13 | 11 (day-3 leg: 15) — copy ready |
> | **Belmar A4 (day 14)** | Fell due 8/24 with A3 still unsent | 4 — see note below |
> | **STASKA A3 (day 7)** | Times sent 8/10 21:01, no answer since | 11 — copy ready |
> | **STASKA A4 (day 14)** | Fell due 8/24 by the calendar, same stall as Belmar's: A3 never sent | 4 — sequence stalled, not exhausted |
...
>
> **Two conversations have been waiting on Taylor since Thursday 8/13 — now fifteen days**, per the 8/14 computation: **Medivant** (missed meeting with a four-person group; reschedule draft staged 8/14, unknown whether sent) and **Globyz/Ahmed** (tirzepatide sourcing request, no draft by design — see the Globyz section). Whether either moved is unobservable.
>
