...
export const SAMPLE_POSTS: DGPost[] = [
  {
    ...
    slides: [
      ...
      { a: "A02", bg: "paper", title: "Arizona's utilities are asking for more.", standfirst: "2025–26 requested residential increase", rows: [{ label: "APS", pct: 100, value: "14%", hot: true }, { label: "TEP", pct: 100, value: "14%" }], ctx: "APS is yours — and 14% is the ask.", source: "ACC filings · APS, TEP · 2026" },
  ...
  },
  {
    ...
    slides: [
      ...
      { a: "A08", bg: "night", eyebrow: "QUESTION 02", label: "WHAT RATE DID YOU ASSUME?", bullets: [{ lead: "APS ~6.2¢", body: "the real export credit — inflated numbers = fantasy savings." }, { lead: "Locked 10 years", body: "from your interconnection date; make them show the plan they used." }], source: "APS RCP schedules" },
