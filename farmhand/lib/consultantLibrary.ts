...
export const CONSULTANT_SHOTS: ConsultantShot[] = [
  ...
  { id: "homeowners2", label: "Consult · two homeowners", job: "the consult moment", preset: "DigitalCamera", aspect: "3:4", scene: "a solar consultant in a plain polo standing beside two older homeowners, pointing at a report on an iPad and explaining it, the two homeowners looking at the screen with natural focused expressions, not big posed smiles, candid mid-conversation, warm natural light inside a Southwest home" },
